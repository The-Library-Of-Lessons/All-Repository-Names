...
if __name__ == "__main__":
    ...
    if os.path.exists('content.json'):
        with open('content.json', 'r') as f:
            data = json.load(f)
        generate_html("The Art of Effective Communication", data, 'template.html', 'The-Art-of-Effective-Communication/index.html')
        print("Generated index.html for The Art of Effective Communication")
